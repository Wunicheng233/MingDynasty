...
window.EffectTypes = {
    ...
    ADD_SKILL_LEVEL: 'add_skill_level', // 直接提升技能等级
    CHANGE_ROLE: 'change_role',         // 改变身份等级（功勋晋升）
    CHANGE_CITY_OWNER: 'change_city_owner', // 改变城池所属势力
    UNLOCK_FACILITY: 'unlock_facility',   // 解锁城市设施
    ...
    UNLOCK_MISSION_CATEGORY: 'unlock_mission_category' // 开放主命任务分类
};
...
const ALL_EVENTS = [
	...
	// ========== 第一章主线：马秀英成婚 ==========
	{
		...
		trigger: {
			time: { year: 1352, month: 5, day: 1, operator: '>=' },
			location: 1, // 濠州
			identity: ['soldier'],
			faction: 1,
	...
	// ========== 第一章主线：郭子兴病逝 ==========
	{
		...
		trigger: {
			time: { year: 1352, month: 9, day: 1, operator: '>=' },
			location: null,
	...
	// ========== 第一章主线：攻占应天 ==========
	{
		...
		trigger: {
			time: { year: 1352, month: 12, day: 1, operator: '>=' },
			location: 4, // 和州
			identity: ['general'],
			faction: 1,
